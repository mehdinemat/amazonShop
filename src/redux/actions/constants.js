...
export const initialDataConstants = {
  GET_ALL_PRODUCT_REQUEST : 'GET_PRODUCT_REQUEST',
  GET_ALL_PRODUCT_SUCCESS : 'GET_PRODUCT_SUCCESS',
  GET_ALL_PRODUCT_FAILURE :'GET_PRODUCT_FAILURE',
  GET_ALL_CATEGORY_REQURES : 'GET_ALL_CATEGORY_REQUEST',
